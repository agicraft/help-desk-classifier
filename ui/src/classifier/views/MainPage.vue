...
import { VCard, VCol, VContainer, VRow, VCardText } from 'vuetify/components';
...
<template>
  <VRow class="bg-containerBg position-relative" no-gutters>
    <div class="blur-logo">
      <svg viewBox="8 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <polygon fill="#69b1ff"
